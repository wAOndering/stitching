...
#path<'InCell6000-Neuro\Rumbaugh Lab\Chubbs\iPSC Project\induced Neurons (iNs)\iN Cell Lines\Cas9 Cell Lines\EGFP Lentivirus iNs\11-26-19_0.1% EGFP iNs_All 4 lines_Day 21\11-26-19_0.1% GFP iNs_WT #30, Homo #4, ans Homo #38_Day 21\11-26-19_0\11-26-19_0_1'
  # x <- scan("clipboard",what="string")
  pathTmp<-getwd()
  print(pathTmp)
  fileTemp<-list.files(pathTmp, pattern='.tif')
  newName1<-c('001','002','041','042','043','101','341','401','402','403','441','442')
